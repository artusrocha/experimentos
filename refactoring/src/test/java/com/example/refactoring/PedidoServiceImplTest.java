...
public class PedidoServiceImplTest {
	...
	PedidoServiceImpl target;

	@Before
	public void setup() {
		String cpf = "000.000.000-00";
		when(clientServiceMock.findByCpf(cpf)).thenReturn(Optional.of(new Client()));
		target = new PedidoServiceImpl(clientServiceMock);
	}

	@Test
	public void testCalculaTotal_Client_1_per_item() {
		String cpf = "000.000.000-00";
		BigDecimal result_1_per_item = target.calT(cpf, getProdutosPedidos(1));
	...
	public void testCalculaTotal_Client_5_per_item() {
		String cpf = "000.000.000-00";
		BigDecimal result_5_per_item = target.calT(cpf, getProdutosPedidos(5));
